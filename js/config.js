...
const CONFIG = {
  ...
  CITY_FALLBACKS: {
    ...
    'osaka': {
      "description": "먹고 쓰러지는 도시, 쿠이다오레의 고향이에요. 도톤보리의 활기와 신세카이의 서민 정서가 공존해요.",
      "senses": { "sight": "도톤보리 강변 글리코 간판과 네온사인의 밤 풍경", "sound": "타코야키 철판 지글거리는 소리와 이자카야 골목의 왁자지껄함", "smell": "쿠시카츠 기름 튀기는 냄새와 다시마 국물의 구수한 향" },
      "seasons": {
        "spring":  { "icon": "🌸", "text": "3~4월 오사카 성 공원의 벚꽃이 절정이에요. 꽃놀이(하나미) 피크 시즌으로 혼잡하지만 분위기는 최고예요." },
        "summer":  { "icon": "🎆", "text": "7~8월 텐진마쓰리(天神祭)와 나니와 요도가와 불꽃놀이가 열려요. 덥고 습하니 저녁 외출을 추천해요." },
        "autumn":  { "icon": "🍁", "text": "10~11월 민노산과 코시엔 주변의 단풍이 아름다워요. 여행 최성수기로 숙소 예약을 서둘러야 해요." },
        "winter":  { "icon": "🦀", "text": "12~2월 겨울 제철 카니(게) 요리와 훠궈 이자카야가 진가를 발휘하는 계절이에요. 도톤보리 일루미네이션도 볼 만해요." }
      },
      "restaurants": [
        { "name": "앗치치 혼포(あっちっちホンポ)", "meal_type": "any", "menu": ["네기 타코야키", "명란 타코야키"], "price": "1인 600~900엔", "reservation": "불필요", "location": "도톤보리 메인 스트리트, 글리코 간판 인근", "tags": ["타코야키", "길거리음식"] },
        { "name": "킨류 라멘(金龍ラーメン) 도톤보리점", "meal_type": "lunch", "menu": ["라멘", "차슈 라멘"], "price": "1인 800~1,000엔", "reservation": "불필요(24시간 영업)", "location": "도톤보리, 에비스바시 남쪽 도보 2분", "tags": ["라멘", "24시간"] },
        { "name": "하나마루켄(花丸軒) 신사이바시점", "meal_type": "lunch", "menu": ["연골차슈 라멘", "쓰케멘"], "price": "1인 1,100~1,400엔", "reservation": "불필요", "location": "신사이바시 상점가 내, 지하철 신사이바시역 도보 3분", "tags": ["라멘", "로컬"] },
        { "name": "야토로우(八とろう) 신세카이점", "meal_type": "dinner", "menu": ["쿠시카츠 세트", "쿠시카츠 모둠(10꼬치)"], "price": "1인 1,500~2,500엔", "reservation": "불필요", "location": "신세카이 쓰텐카쿠 탑 바로 아래 골목", "tags": ["쿠시카츠", "신세카이"] },
        { "name": "후쿠타로(ふくたろ) 난바점", "meal_type": "dinner", "menu": ["네기야키", "스지네기야키"], "price": "1인 1,200~2,000엔", "reservation": "저녁은 웨이팅 가능", "location": "난바 WALK 상점가 근처, 지하철 난바역 도보 5분", "tags": ["오코노미야키", "네기야키"] },
        { "name": "스미비 야키토리 도리키치(鳥吉) 우라난바점", "meal_type": "dinner", "menu": ["모모야키", "쓰쿠네", "야키토리 세트"], "price": "1인 2,000~3,500엔(음료 포함)", "reservation": "저녁 예약 권장", "location": "우라난바 골목, 난바역 남동쪽 도보 7분", "tags": ["야키토리", "이자카야"] },
        { "name": "이치란 라멘(一蘭) 도톤보리점", "meal_type": "lunch", "menu": ["천연 돈코츠 라멘", "곱빼기 라멘"], "price": "1인 980~1,480엔", "reservation": "불필요(1인 칸막이석)", "location": "도톤보리 강변 서쪽, 에비스바시 도보 3분", "tags": ["라멘", "혼밥"] }
      ],
      "map": { "lat": 34.6685, "lng": 135.5023, "zoom": 13, "legend": [{"c":"#C4704B","l":"명소"}, {"c":"#7A9A7E","l":"맛집"}], "pins": [
        {"lat":34.6687, "lng":135.5014, "name":"도톤보리", "time":"오후 6시", "note":"오사카 최고 번화가, 글리코 간판과 강변 야경"},
        {"lat":34.6501, "lng":135.5061, "name":"신세카이·쓰텐카쿠", "time":"오후 3시", "note":"쿠시카츠 발상지, 레트로 분위기의 서민 동네"},
        {"lat":34.6931, "lng":135.5019, "name":"오사카 성", "time":"오전 10시", "note":"도요토미 히데요시가 지은 오사카의 상징"},
        {"lat":34.6652, "lng":135.4946, "name":"구로몬 시장(黒門市場)", "time":"오전 11시", "note":"오사카의 주방, 신선한 해산물과 길거리 먹거리"},
        {"lat":34.7024, "lng":135.4960, "name":"나카자키초", "time":"오후 2시", "note":"낡은 골목에 감성 카페와 빈티지숍이 모인 동네"}
      ] }
    },
    'lisbon': {
      "description": "알파마 골목에서 파두 선율이 흘러나오는 언덕 도시예요. 아줄레주 타일과 트램, 포르투갈 와인이 여행자를 감싸요.",
      "senses": { "sight": "상 조르제 성에서 내려다보는 테주강과 붉은 지붕", "sound": "타스카 안에서 새어 나오는 파두 선율", "smell": "파스텔 드 나타 갓 구운 달콤한 에그타르트 향" },
      "seasons": {
        "spring":  { "icon": "🌿", "text": "3~5월 기온이 온화하고 인파가 비교적 적어 최고의 여행 시즌이에요. 미모사 꽃이 거리를 노랗게 물들여요." },
        "summer":  { "icon": "☀️", "text": "6~8월 성수기로 해변 도시 카스카이스와 함께 여행하기 좋아요. 리스본 자체는 덥고 관광객이 몰려요." },
        "autumn":  { "icon": "🍇", "text": "9~10월 포도 수확 시즌, 알렌테주 와인 투어와 결합하면 완벽해요. 날씨도 쾌적해요." },
        "winter":  { "icon": "🎄", "text": "12~2월 비가 잦지만 관광객이 적고 현지 분위기를 더 깊이 느낄 수 있어요. 파두 공연 예약이 훨씬 쉬워요." }
      },
      "restaurants": [
        { "name": "제 다 모우라리아(Zé da Mouraria)", "meal_type": "lunch", "menu": ["바칼류 엠 민호타(대구 카라멜 양파 올리브)", "폴보 아 라가레이루(문어 올리브오일)"], "price": "1인 12~18유로", "reservation": "불필요(인기 많아 오픈 직후 방문 추천)", "location": "모우라리아 광장 근처, 지하철 마르팅 모니스역 도보 3분", "tags": ["타스카", "바칼류", "로컬"] },
        { "name": "타스카 두 시쿠(Tasca do Chico)", "meal_type": "dinner", "menu": ["페티스코스 모둠", "카르네 드 포르쿠 아 알렌테자나(돼지고기 조개찜)"], "price": "1인 15~22유로", "reservation": "저녁 예약 필수(파두 공연 있음)", "location": "마두레이라, 지하철 에스텔라역 도보 5분 / 알칸타라점도 있음", "tags": ["파두", "타스카", "페티스코스"] },
        { "name": "제 두스 코르누스(Zé dos Cornos)", "meal_type": "dinner", "menu": ["숯불 갈비(코스텔라스)", "바이어우 빈 토마토 샐러드"], "price": "1인 13~20유로", "reservation": "불필요(웨이팅 가능)", "location": "알파마 골목, 28번 트램 종점 포르타스 두 솔 인근", "tags": ["알파마", "숯불구이", "로컬"] },
        { "name": "파스텔라리아 베르나르두(Pastelaria Bernardo)", "meal_type": "any", "menu": ["파스텔 드 나타(에그타르트)", "비파나(돼지고기 샌드위치)"], "price": "1인 3~6유로", "reservation": "불필요", "location": "바이샤 지구, 리스본 대성당 도보 5분", "tags": ["베이커리", "스낵", "현지인 아침"] },
        { "name": "세르베자리아 하미루(Cervejaria Ramiro)", "meal_type": "dinner", "menu": ["감바스 그렐라다스(새우구이)", "상타굴라스(왕새우)"], "price": "1인 30~50유로", "reservation": "예약 필수(2주 전)", "location": "인텐덴테 광장 근처, 지하철 인텐덴테역 도보 2분", "tags": ["해산물", "스페셜"] },
        { "name": "타베르나 다 루아 다스 플로레스(Taberna da Rua das Flores)", "meal_type": "lunch", "menu": ["페티스코스 현지 모둠", "아로스 드 파투(오리 리조또)"], "price": "1인 18~28유로", "reservation": "예약 권장", "location": "시아두, 카몽이스 광장 도보 3분", "tags": ["타베르나", "모던포르투갈"] }
      ],
      "map": { "lat": 38.7223, "lng": -9.1393, "zoom": 13, "legend": [{"c":"#C4704B","l":"명소"}, {"c":"#7A9A7E","l":"맛집"}], "pins": [
        {"lat":38.7140, "lng":-9.1336, "name":"알파마·상 조르제 성", "time":"오전 10시", "note":"리스본에서 가장 오래된 동네, 성에서 테주강 파노라마"},
        {"lat":38.7113, "lng":-9.1365, "name":"28번 트램 노선", "time":"오전 11시", "note":"알파마를 누비는 레트로 노란 트램, 리스본의 상징"},
        {"lat":38.7097, "lng":-9.1365, "name":"파두 박물관", "time":"오후 2시", "note":"포르투갈 영혼의 음악 파두의 역사와 감성"},
        {"lat":38.7132, "lng":-9.1426, "name":"모우라리아 광장", "time":"오후 3시", "note":"이민자 문화와 파두가 공존하는 진짜 리스본 골목"},
        {"lat":38.7076, "lng":-9.1368, "name":"벨렝 탑(Torre de Belém)", "time":"오후 5시", "note":"대항해시대의 기념비적 탑, 테주강 일몰 명소"}
      ] }
    }
  },
